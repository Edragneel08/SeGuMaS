<%-- 
    Document   : viewListSite
    Created on : 8 Jun 2024, 4:09:33 pm
    Author     : edrag
--%>
<%-- 
    Document   : listStaff
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="<%=request.getContextPath()%>/listSite" style="color: blue;" >LIST OF SITE</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                        ...
                        <div>
                            ...
                            <div class="table-wrapper">
                                <table class="table table-striped table-bordered table-hover" id="siteTable">
                                    ...
                                    <tbody id="siteTableBody" style="background-color:white"> 
                                        <c:forEach var="site" items="${listSite}" varStatus="num">
                                            <tr>
                                                <td>${num.index + 1}</td>
                                                ...
                                                <td style="text-align: center;">
                                                    <c:choose>
                                                        <c:when test="${site.status == 'Active'}">
                                                            <p class="label label-success"><c:out value="${site.status}"/></p>
                                                        </c:when>
                                                        <c:when test="${site.status == 'Not Active'}">
                                                            <p class="label label-danger"><c:out value="${site.status}"/></p>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <p class="label label-default"><c:out value="${site.status}"/></p>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </td>
                                ...
                                <input type="hidden" id="listSiteSize" value="${listSite.size()}">
                            ...
                            <script>
                                ...
                                function showPage(pageNumber) {
                                    ...
                                    var rows = document.getElementById('siteTableBody').rows;
                                ...
                                function generatePagination() {
                                    var itemsPerPage = parseInt(document.getElementById('itemsPerPage').value);
                                    var totalItems = parseInt(document.getElementById('listSiteSize').value);
